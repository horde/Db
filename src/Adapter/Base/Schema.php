...
abstract class Schema
{
     ...
     *
     * @return ColumnDefinition  A column definition
     *                                                 object.
     */
    ...
    {
        return new Index($table, $name, $primary, $unique, $columns);
    }
    ...
    {
        return new Table($name, $primaryKey, $columns, $indexes);
    }
     ...
     *
     * @throws DbException if column not found.
     * @return Column  A column object.
     */
    public function column($tableName, $columnName)
    {
        ...
        throw new DbException("$tableName does not have a column '$columnName'");
    }
     ...
     *                        description.
     *
     * @return TableDefinition  The definition of the
     *                                                created table.
     */
    ...
    public function indexName($tableName, $options = [])
    {
        ...
        throw new DbException('You must specify the index name');
    }
