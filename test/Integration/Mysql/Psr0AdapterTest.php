...
/**
 * MySQL integration tests for PSR-0 variant.
 *
 * @category Horde
 * @package  Db
...
/**
 * Test Horde_Db with MySQL using PSR-0 (lib/) variant.
 *
 * @covers Horde_Db_Adapter_Mysqli
 */
class Psr0AdapterTest extends DatabaseTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->conn = new Horde_Db_Adapter_Mysqli($config);
    }
