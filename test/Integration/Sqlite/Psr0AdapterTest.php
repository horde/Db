...
/**
 * SQLite integration tests for PSR-0 variant.
 *
 * @category Horde
 * @package  Db
...
/**
 * Test Horde_Db with SQLite using PSR-0 (lib/) variant.
 *
 * @covers Horde_Db_Adapter_Pdo_Sqlite
 */
class Psr0AdapterTest extends DatabaseTestCase
{
    private $conn;
    ...
    protected function setUp(): void
    {
        ...
        $this->conn = new Horde_Db_Adapter_Pdo_Sqlite($config);
    }
